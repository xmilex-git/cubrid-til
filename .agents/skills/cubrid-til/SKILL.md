...
이미 축적된 지식으로 답만 원하는 질문은 이 스킬 대신 [cubrid-ask](../cubrid-ask/SKILL.md)를 사용한다.
...
- 확정된 사실은 canonical note에 즉시 병합하고 wikilink를 갱신한다. 새 canonical note는 해당 폴더의 Index note에, 새 session은 [[Discussion Sessions Index]]에 등록한다.
