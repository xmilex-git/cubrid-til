...
| Main iteration 종료와 post-processing 경계 | engine | 3 | [[2026-07-23-003 Query executor main block]] | `qexec_end_mainblock_iterations()`을 어느 실행 구간에 포함할지와 analytic function 최적화 예외를 검증한다. | [[Query executor의 main block 실행]] | 1 | queued |
